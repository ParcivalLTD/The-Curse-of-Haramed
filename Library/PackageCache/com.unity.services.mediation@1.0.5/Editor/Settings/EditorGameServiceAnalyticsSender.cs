...
namespace Unity.Services.Mediation.Settings.Editor
{
    class EditorGameServiceAnalyticsSender
    {
        ...
        static class AnalyticsAction
        {
            ...
            public const string EnableBuildSetting = "Enable Build Setting";
            public const string DisableBuildSetting = "Disable Build Setting";
        }
        ...
        internal static void SendBuildSettingsEvent(string buildSetting, bool enabled)
        {
            SendEvent(AnalyticsComponent.BuildSettings, (enabled ? AnalyticsAction.EnableBuildSetting :
                AnalyticsAction.DisableBuildSetting) + "-" + buildSetting);
        }
