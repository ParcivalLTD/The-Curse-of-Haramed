...
namespace Unity.Services.Mediation.UI
{
    ...
    public class UIBannerAd : UIBehaviour
    {
        ...
        const string k_ServicesInitializeFailed = "BannerAdUI attempted to initialize UnityServices and failed: ";
        ...
        async Task CreateAndLoadBanner()
        {
            ...
            {
                MediationLogger.LogWarning(e.Message);
            }
        ...
        async Task InitializeServices()
        {
            ...
            {
                MediationLogger.LogError($"{k_ServicesInitializeFailed}{e.Message}");
            }
        }
